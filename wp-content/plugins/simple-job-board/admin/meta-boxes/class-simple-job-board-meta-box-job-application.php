                ...
                if (NULL != $keys):
                    foreach ($keys as $key):
                        if (substr($key, 0, 7) == 'jobapp_'):
                            ...
                            . '<select class="jobapp_field_type" name="' .  esc_attr( $key ) . '[type]">'
                            ...
                            if ('checkbox' === $val['type'] || 'dropdown' === $val['type'] || 'radio' === $val['type']):
                                ...
                                echo '<input type="text" name="' .  esc_attr( $key ) . '[options]" class="jobapp-field-options" placeholder="Option1, option2, option3" style="display:none;"  />&nbsp;';
                            endif;
                            ...
                            echo '<input type="hidden" class="jobapp-applicant-column" name="' .  esc_attr( $key ) . '[applicant_column]" value="' . esc_attr( $is_applicant_column ) . '"/>';
