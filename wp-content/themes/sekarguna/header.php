            ...
            <ul class="collection">
              ...
              <li class="collection-item" style="animation-duration: 1.25s">
                ...
                <ul class="sub-menu-mobile">
                  ...
                  <li><a href="<?= get_home_url(); ?>/jobs">Career</a></li>
                </ul>
              </li>
              <li class="collection-item" style="animation-duration: 1.50s">
                ...
                <ul class="sub-menu-mobile">
                  ...
                  <li><a target="_blank" href="https://university.myalkes.com/login">E - Learning</a></li>
                  <li><a target="_blank" href="https://myalkes.com/">E - Commerce</a></li>
                </ul>
              </li>
              ...
              <div class="header-content">
                <nav class="nav-logo">
                  ...
                  <div class="logo scrollnav">
                    <a href="<?= get_home_url(); ?>"><img src="<?= get_stylesheet_directory_uri() . '/assets/images/sekarguna-logo.png'; ?>" alt="logo PT. Sekarguna Medika" />Sekarguna Medika</a>
                  </div>
                </nav>
                <nav class="nav-menu">
                    ...
                    <ul>
                      ...
                      <li class="menu-dropdown">
                        ...
                        <div class="dropdown-content">
                          ...
                          <a href="<?= get_home_url(); ?>/jobs">Career</a>
                        </div>
                      </li>
                      <li class="menu-dropdown">
                        ...
                        <div class="dropdown-content">
                          ...
                          <a target="_blank" href="https://university.myalkes.com/login">E - Learning</a>
                          <a target="_blank" href="https://myalkes.com/">E - Commerce</a>
                        </div>
                      </li>
